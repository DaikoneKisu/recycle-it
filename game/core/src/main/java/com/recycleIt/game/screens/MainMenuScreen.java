...
public class MainMenuScreen extends AbstractScreen {
  ...
  public MainMenuScreen(RecycleIt game) {
    super(game);
  }
  ...
  public void show() {
    ...
    playButtonNormal = new Texture(Gdx.files.internal("sprites/buttons/Start/Start1.png"));
    playButtonHover = new Texture(Gdx.files.internal("sprites/buttons/Start/Start2.png"));
    playButtonPressed = new Texture(Gdx.files.internal("sprites/buttons/Start/Start3.png"));

    exitButtonNormal = new Texture(Gdx.files.internal("sprites/buttons/Quit/Quit1.png"));
    exitButtonHover = new Texture(Gdx.files.internal("sprites/buttons/Quit/Quit2.png"));
    exitButtonPressed = new Texture(Gdx.files.internal("sprites/buttons/Quit/Quit3.png"));
  ...
  public void render(float delta) {
    ...
    if (Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
      if (isPlayButtonHovered && !isPlayButtonClicked) {
        ...
        this.GAME.screenController.show(Screen.Game);
      }
